...
2. The key_indicator notebook is an explanantion of the key indicators and an example of how you could use them to find specific objects of groups of objects
3. The sitereport notebook give a summary and analysis of the results for one municipality and compares those results to the water feature, the river bassin and the national results
